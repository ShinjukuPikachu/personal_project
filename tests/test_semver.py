...
class TestCalculateBump:
    ...
    def test_feat_only_returns_minor(self):
        ...
        commits = [ParsedCommit(
            hash="a" * 40, short_hash="aaaaaaa", author="A", date="2026-06-01T00:00:00Z",
            subject="feat: foo", body="", commit_type="feat", scope=None,
            is_breaking=False, breaking_note=None, clean_subject="foo",
        )]
    ...
    def test_fix_only_returns_patch(self):
        from release_pilot.models import ParsedCommit
        commits = [ParsedCommit(
            hash="b" * 40, short_hash="bbbbbbb", author="B", date="2026-06-01T00:00:00Z",
            subject="fix: bar", body="", commit_type="fix", scope=None,
            is_breaking=False, breaking_note=None, clean_subject="bar",
        )]
    ...
    def test_chore_only_returns_none(self):
        from release_pilot.models import ParsedCommit
        commits = [ParsedCommit(
            hash="c" * 40, short_hash="ccccccc", author="C", date="2026-06-01T00:00:00Z",
            subject="chore: update deps", body="", commit_type="chore", scope=None,
            is_breaking=False, breaking_note=None, clean_subject="update deps",
        )]
    ...
    def test_perf_returns_patch(self):
        from release_pilot.models import ParsedCommit
        commits = [ParsedCommit(
            hash="d" * 40, short_hash="ddddddd", author="D", date="2026-06-01T00:00:00Z",
            subject="perf: speed", body="", commit_type="perf", scope=None,
            is_breaking=False, breaking_note=None, clean_subject="speed",
        )]
        assert calculate_bump(commits) == "patch"
...
class TestBuildChangeset:
    ...
    def test_no_breaking_commits(self):
        from release_pilot.models import ParsedCommit
        commits = [ParsedCommit(
            hash="e" * 40, short_hash="eeeeeee", author="E", date="2026-06-01T00:00:00Z",
            subject="fix: baz", body="", commit_type="fix", scope=None,
            is_breaking=False, breaking_note=None, clean_subject="baz",
        )]
