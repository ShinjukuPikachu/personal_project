...
def sample_commit_infos() -> list[CommitInfo]:
    return [
        CommitInfo(
            ...
            subject="feat(picking): add vision-guided pick confirmation (MUJIN-456)",
            body="MUJIN-456",
        ),
        CommitInfo(
            ...
            subject="feat(api)!: rename /api/v1/robot-status to /api/v2/status (MUJIN-789)",
        ...
        CommitInfo(
            ...
            subject="fix(palletizing): resolve stack overflow (MUJIN-234)",
            body="MUJIN-234",
        ),
        CommitInfo(
...
def sample_release_result() -> ReleaseResult:
    ...
    traceability = [
        TraceabilityRow(
            ...
            commit_type="feat",
            is_breaking=False,
            jira_tickets=[JiraTicket(key="MUJIN-456", summary="Vision pick confirm", status="Done", issue_type="Story", priority="High")],
            pr_number=45,
            pr_url="https://github.com/mujin/mujinos/pull/45",
        ...
        TraceabilityRow(
            ...
            commit_type="feat",
            is_breaking=True,
            jira_tickets=[JiraTicket(key="MUJIN-789", summary="API versioning", status="Done", issue_type="Task", priority="High")],
            pr_number=46,
            pr_url="https://github.com/mujin/mujinos/pull/46",
    ...
    return ReleaseResult(
        ...
        readiness=readiness,
        internal_announcement="MujinOS v2.3.0 is released.",
        customer_notes="## What's New\n\n- Vision-guided pick confirmation.",
        marketing_notes="MujinOS v2.3.0 delivers faster picking.",
