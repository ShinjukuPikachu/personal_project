...
2. **Audience tiering** — For each customer-facing change, determine the right audience:
   ...
   - **Marketing release notes** (`marketing`): major new capabilities, integrations with enterprise systems (SAP EWM, new WMS connectors), significant performance milestones, features that differentiate NyankoOS competitively
...
- **Marketing release notes**: outcome-first, aspirational but grounded. "NyankoOS v2.3.0 delivers a 40% faster motion planning pipeline, new SAP EWM integration, and real-time joint health monitoring — giving warehouse operators faster cycle times and proactive hardware alerts."
